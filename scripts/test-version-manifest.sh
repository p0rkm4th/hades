...
required=(HADES_HERMES_VERSION HADES_OPEN_WEBUI_VERSION HADES_LLDAP_IMAGE HADES_HINDSIGHT_IMAGE_DIGEST HADES_GROCY_IMAGE HADES_AGENT_ZERO_IMAGE HADES_ACTUAL_VERSION)

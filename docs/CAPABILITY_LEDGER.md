...
| Memory + household composition | PARTIAL | Hindsight + Grocy | A synthetic recipe-fixture fact was retained and recalled through HADES, combined with live Grocy fulfillment in one owner turn, and the corrected label was returned by a fresh mobile DOM query without changing the canonical Grocy recipe. | Broader correction coverage remains open; Grocy remains authoritative for live state. |

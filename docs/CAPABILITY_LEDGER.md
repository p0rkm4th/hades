...
| Memory + household composition | PARTIAL | Hindsight + Grocy | A synthetic recipe-fixture fact was retained and recalled through HADES, combined with live Grocy fulfillment in one owner turn, and corrected in a later turn without changing the canonical Grocy recipe; mobile DOM and reload were verified. | Broader correction coverage remains open; Grocy remains authoritative for live state. |

...
| Memory + household composition | PARTIAL | Hindsight + Grocy | A synthetic recipe-fixture fact was retained and recalled through HADES, then combined with live Grocy fulfillment; the response reported the current recipe state. | Browser-DOM/new-session acceptance and correction behavior remain open; Grocy remains authoritative for live state. |

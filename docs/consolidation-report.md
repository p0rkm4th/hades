...
390 focused A2A, Hindsight, API-server, and gateway tests. This is strong
upstream evidence, not permission to replace the known-good production
runtime; a full synthetic owner-contract matrix and rollback rehearsal remain
before migration.
